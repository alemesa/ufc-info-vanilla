...
axios.get('https://cors-anywhere.herokuapp.com/http://ufc-data-api.ufc.com/api/v3/iphone/fighters/title_holders').then(function (response) {
...
axios.get('https://cors-anywhere.herokuapp.com/http://ufc-data-api.ufc.com/api/v3/iphone/events').then(function (response2) {
...
axios.get('https://cors-anywhere.herokuapp.com/http://ufc-data-api.ufc.com/api/v3/iphone/news').then(function (response3) {
...
var endpoint = 'https://cors-anywhere.herokuapp.com/http://ufc-data-api.ufc.com/api/v3/iphone/fighters';
...
function getFighters() {
  ...
  fighterQuery.forEach(function (fighter) {
    return fighter.addEventListener('click', function displayFighter(e) {
      ...
      axios.get('https://cors-anywhere.herokuapp.com/http://ufc-data-api.ufc.com/api/v3/iphone/fighters/' + this.dataset.id + '.json').then(function (response4) {
